...
<div class="col-md-12 mt-5 pt-3 border-bottom">
    <div class="text-dark px-0">
        <p class="mb-1"><a href="{{route('admin.dashboard')}}"><i class="fa fa-home"></i> Dashboard / </a><a href="" class="active-slink">Promo Code / </a><a class="active-slink">Promo Code List</a> <span class="top-date">Total Promo Codes : {{$promocode->count()}}</span></p>
...
<div class="container-fluid p-3">
    <div class="box">
        <div class="box-header">
            ...
            <h2 class="blue task-label">All Promo Codes</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="table-data">
                            <?php $counter = 0; ?>
                            @foreach($promocode as $key=>$promo)
                            <?php $counter++; ?>
                            <tr>
                                <td>{{$counter}}</td>
                                <td>{{$promo->name}}</td>
                                ...
                                <td style="width:120px;">
                                    ...
                                    <div class="del-modal <?php echo 'modal' . $counter ?>">
                                        ...
                                        <form method="post" action="{{route('admin.product.promoCodeDelete')}}" style="float:right;">
                                            @csrf
                                    ...
                                    <p class="btn bg_secondary_grey mb-0 p-1 px-2 del-btn <?php echo 'btn' . $counter ?>" data-store_id="{{$promo->id}}" style="font-size: 13px;relative;cursor:pointer;" title="Delete product"> <i class="fa fa-trash"></i></p>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
